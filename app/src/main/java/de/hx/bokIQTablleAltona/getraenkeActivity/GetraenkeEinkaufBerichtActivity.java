...
import de.hx.bokIQTablleAltona.xml.getraenke.GetraenkeEinkaufPreisXmlParser;

public class GetraenkeEinkaufBerichtActivity extends Activity {

    GetraenkeEinkaufPreisXmlParser fEPXP = new GetraenkeEinkaufPreisXmlParser();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.getraenke_einkaufbericht);
